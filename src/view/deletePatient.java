...
public class deletePatient extends javax.swing.JFrame {
    ...
    if(patientID.isEmpty()){
        ...
        JOptionPane.showMessageDialog(this,"Format must be PAT-####","VALIDATION MESSAGE",JOptionPane.ERROR_MESSAGE);
           ...
           Patient patientObj = new Patient();
            ...
            int rowsAffected = dao.deletePatient(patientObj);
            if(rowsAffected > 0){
                JOptionPane.showMessageDialog(this,"PATIENT IS DELETE SUCCESSFULL");
            }
            else{
                    JOptionPane.showMessageDialog(this,"NO PATIENT HAS THIS ID");
            } 
        }     
    ...
    private void clearBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_clearBtnActionPerformed
        ...
        patientIdtxt.requestFocusInWindow();
